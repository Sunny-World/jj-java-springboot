...
public class ShiroConfig {
    ...
    @Bean
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager, ShiroResources shiroResources) {

        ShiroFilterFactoryBean shiroFilterFactoryBean = new ShiroFilterFactoryBean();
        shiroFilterFactoryBean.setSecurityManager(securityManager);

        HashMap<String, Filter> filters = new HashMap<String,Filter>();
        filters.put("defender",new AccessDefenderFilter(shiroResources));
        shiroFilterFactoryBean.setFilters(filters);

        HashMap<String,String> filterChainMap = new HashMap<>();
        filterChainMap.put("/**","defender");
